...
class HQCJNewsCrawler(NewsCrawler):
    ...
    def parse_list_page(self, content):
        ...
        for _,url,title,_,_,_,_,pub_date, in self.list_pattern.findall(content):
